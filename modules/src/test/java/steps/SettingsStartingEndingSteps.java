...
public class SettingsStartingEndingSteps {
	...
	public void afterForForms() {
		SeleniumReadPropertyKeys.DRIVER.navigate()
				.to("https://forms.liferay.com/" + SeleniumReadPropertyKeys.getLinkToLogOut());
	}
	...
	public void afterScenario(Scenario scenario) {
		...
		SeleniumReadPropertyKeys.DRIVER.navigate()
				.to(SeleniumReadPropertyKeys.getUrlToHome() + SeleniumReadPropertyKeys.getLinkToLogOut());
	}
}